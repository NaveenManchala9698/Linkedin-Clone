      ...
      <Row className="mynav">
        ...
        <Col md={8} style={{ flexBasis: "fit-content", padding: "0" }}>
          <Nav className="nav-links my-2 mx-4">
            ...
            <a href="#jobs" className="nav-text mr-3">
              <BriefcaseFill className="nav-icons" />
              <span>Jobs</span>
            </a>
            <a href="#messaging" className="nav-text mr-3">
              <ChatDotsFill className="nav-icons" />
              <span>Messaging</span>
            </a>
            <a href="#notifications" className="nav-text mr-3">
              <BellFill className="nav-icons" />
              <span>Notifications</span>
            </a>
            <a href="#me" className="nav-text mr-3">
              <Bag className="nav-icons" />
              <span>
                Me
                <CaretDownFill />
              </span>
